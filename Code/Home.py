...
if check_password():
    ...
    kunder = ['Stark', 'NyborgKommune']#, 'FitnessWorld', 'Jeudan1', 'BallerupKommune', 'BallerupKommune1', 'Privat_elforbrug_test', 'Syntese', 'DanskeBank', 'Siemens Gamesa', 'NykreditMaegler', 'Bahne', 'Horsens Kommune', 'G4S', 'VinkPlast', 'MilestoneSystems', 'Premier Is']
