...
if check_password():
    ...
    col1.dataframe(df_besp[['Adresse', 'årligt forbrug']].sort_values('årligt forbrug', ascending=True).round(1).head(10).style.background_gradient(cmap='Reds'), use_container_width=True)
